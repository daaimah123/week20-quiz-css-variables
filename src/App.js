...
=======
  ...
  function setColor(newColor) {
    ...
    // Also directly set the fill on the SVG element for browsers that might not support CSS variables well
    const svgElement = document.querySelector(".App-logo g")
    if (svgElement) {
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p onClick={onSVGClick}>
          {/* Modified SVG to use CSS variable for fill color */}
          <svg className="App-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 841.9 595.3">
            <g>
